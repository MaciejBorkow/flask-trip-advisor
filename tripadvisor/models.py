...
class BoardingCard:
    ...
    def serialize(self, serializer):
        ...
        serializer.where_start_and_seat(self.transportation)
    ...
    #
    #         verbose = f"From {self.departure.address}, take {self.transportation.category} to {self.destination.address}."
